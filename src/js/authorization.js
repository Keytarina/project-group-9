...
}); // зміна теми вікна авторизаці при натисканні на кнопку "switch"
// // - - - - - - - - - - - - - - - /зміна теми вікна авторизації - - - - - - - - - - - - - - -
...
const auth = getAuth(); // повертаємо в змінну "auth" екземпляр Auth, пов’язаний із наданим @firebase застосунком
