...
const bestSellerslist = document.querySelector('.bestSellersList');
     ...
     <ul class="bestSellersList">${books
       .map(book => {
         ...
         return `<li class="bestSellersListItem" data-id=${id}>
              <div class="bestSellersThumb"><img class="bestSellersImage" src=${book_image} alt=${title}  data-id-img=${id}/></div>
